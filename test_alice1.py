...
def run(playwright: Playwright) -> None:
    ...
    # Click text=19 hello word alice Norun None PASS FAIL Details Delete >> :nth-match(button, 4)

    page.click("text=19 hello word alice Norun None PASS FAIL Details Delete >> :nth-match(button, 4)")
    # ---------------------
    context.close()
    browser.close()
def test_new_alice1():
